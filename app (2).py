...
# The data is already cleaned, so no need to drop columns or nulls here.
# df_am12_bb20_rj43_dropped = df_am12_bb20_rj43.drop([...], axis=1)
# df_am12_bb20_rj43_cleaned = df_am12_bb20_rj43_dropped.dropna().copy()
